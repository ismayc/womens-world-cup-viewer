...
const matches = [
  {
    num: 1, stage: 'Group', group: 'A', t1: 'Germany', t2: 'Scotland',
  ...
  {
    num: 74, stage: 'QF', t1: 'Belgium', t2: 'Germany',
  ...
  { num: 2, stage: 'Group', group: 'B', t1: 'France', t2: 'Albania', ko: '2026-06-12T15:00:00-04:00', espnId: 'e9', score: [1, 1], goals: { t1: [], t2: [] } },
  { num: 90, stage: 'SF', t1: 'Germany', t2: 'Chile', ko: '2026-07-05T15:00:00-04:00' }, // unplayed → excluded
]

const scorer = { name: 'Raúl Jiménez', team: 'Germany', goals: 3, pens: 1, assists: 2, minutes: 300 }
...
describe('PlayerDetail — the same shapes from the home side', () => {
  ...
  const board = [
    ...
    home(1, 'R16', { score: [1, 1], pens: [5, 4], goals: { t1: [], t2: [] } }),
    ...
    home(2, 'QF', { score: [2, 2], pens: [3, 3], goals: { t1: [], t2: [] } }),
  ...
  it('pluralises a scorer with more than one penalty', () => {
    // One reads "(1 pen)" (the away board above); two or more have to read
    // "(2 pens)" rather than borrowing the singular.
    fetchMatchLines.mockImplementation(async () => ({ length: 90, byName: {} }))
