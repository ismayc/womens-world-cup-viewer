...
// in progress (m.live) or just-finished and overlaid from ESPN (m.liveSource).
// The 164 goals already sitting in the committed schedule must NOT notify, or
// every page load would fire the lot.
