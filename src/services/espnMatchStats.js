...
// `conmebol.america` was wrong without being broken. Corrected anyway: relying on
// ESPN to keep ignoring the slug is not a contract, and the wrong slug is what
// made the same mistake invisible in espnStats.js, where it DID serve another
