...
//
// The Euro sibling adds a "Qualifiers ranking" row as its final tie-breaker's
// value. FIFA 2023 has no equivalent — its last criterion is a drawing of lots —
// so there is deliberately no such row here.
