...
// derived from the merged match list (the committed schedule for finished
// matches, the ESPN live overlay for in-progress ones), so a goal shows here
// moments after it lands on the scoreboard. Assists and minutes played — the official award tie-breakers —
