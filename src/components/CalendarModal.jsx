      ...
      <div className="md-card cal-modal" ref={cardRef} tabIndex={-1} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="md-section">
          ...
          <div className="cal-downloads">
            <button onClick={() => downloadICSCollection(matches, 'womens-world-cup-2023-all.ics')}>
              All matches ({matches.length})
            </button>
            <button onClick={() => downloadICSCollection(filtered, 'womens-world-cup-2023-filtered.ics')}>
              Current filter ({filtered.length})
            </button>
            {count > 0 && (
              <button onClick={() => downloadICSCollection(myMatches, 'womens-world-cup-2023-my-teams.ics', "Women's World Cup 2023 — My Teams")}>
